...
export function GeneralSection() {
  ...
  return (
    <div className="space-y-8">
      ...
      {!isTauri && (
        <div>
          <h2 className="text-lg font-semibold text-foreground mb-1">Desktop App</h2>
          <p className="text-sm text-muted-foreground mb-4">
            Install the desktop app to run AI agents on your local machine.
          </p>
          <div className="flex flex-wrap gap-2">
            <a
              href="https://github.com/tmugavero/jaibber/releases/latest"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 bg-primary text-primary-foreground rounded-lg px-4 py-2 text-sm font-medium hover:bg-primary/90 transition-all"
            >
