...
export function ContactList({ activeId, onSelect, onOpenSettings }: Props) {
  ...
  return (
    <div className="flex flex-col h-full bg-sidebar border-r border-border">
      ...
      {/* Bottom user bar — entire bar is clickable to open settings */}
      <button
        onClick={onOpenSettings}
        title="Settings"
        className="border-t border-border px-3 py-2.5 flex items-center gap-2 w-full text-left hover:bg-muted/30 transition-colors cursor-pointer"
      >
