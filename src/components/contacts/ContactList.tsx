...
export function ContactList({ activeId, onSelect, onOpenSettings, onOpenProjects, onOpenAdmin, onOpenBilling }: Props) {
    ...
    <div className="flex flex-col h-full bg-sidebar border-r border-border">
      ...
      <div className="px-4 pt-5 pb-4 border-b border-border">
        <div className="flex items-center justify-between mb-1">
          ...
          <div className="flex items-center gap-1">
            ...
            <button
              ...
              title="My Projects"
              className="text-muted-foreground hover:text-foreground transition-colors p-1.5 rounded-md hover:bg-muted/50 min-w-[36px] min-h-[36px] flex items-center justify-center"
            >
              <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.5 2C1.22386 2 1 2.22386 1 2.5V12.5C1 12.7761 1.22386 13 1.5 13H13.5C13.7761 13 14 12.7761 14 12.5V4.5C14 4.22386 13.7761 4 13.5 4H7.70711L6.35355 2.64645C6.25979 2.55268 6.13261 2.5 6 2.5H1.5ZM0 2.5C0 1.67157 0.671573 1 1.5 1H6C6.39782 1 6.77936 1.15804 7.06066 1.43934L8.29289 2.67157L13.5 2.67157C14.3284 2.67157 15 3.34315 15 4.17157V12.5C15 13.3284 14.3284 14 13.5 14H1.5C0.671573 14 0 13.3284 0 12.5V2.5Z" fill="currentColor" fillRule="evenodd" clipRule="evenodd"/>
              </svg>
            </button>
            ...
            {onOpenAdmin && (
              ...
              >
                <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M1 1.5A.5.5 0 011.5 1h12a.5.5 0 01.5.5v12a.5.5 0 01-.5.5h-12a.5.5 0 01-.5-.5v-12zM2 2v11h11V2H2z" fill="currentColor"/>
                  <path d="M4 5h7v1H4V5zM4 7.5h5v1H4v-1zM4 10h7v1H4v-1z" fill="currentColor"/>
                </svg>
              </button>
            )}
            {/* Billing button */}
            {onOpenBilling && (
              ...
              >
                <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M2 3.5A1.5 1.5 0 013.5 2h8A1.5 1.5 0 0113 3.5v8a1.5 1.5 0 01-1.5 1.5h-8A1.5 1.5 0 012 11.5v-8zM3.5 3a.5.5 0 00-.5.5V5h9V3.5a.5.5 0 00-.5-.5h-8zM12 6H3v5.5a.5.5 0 00.5.5h8a.5.5 0 00.5-.5V6z" fill="currentColor"/>
                </svg>
              </button>
            )}
            {/* Settings button */}
        ...
        <div className="text-xs text-muted-foreground flex items-center gap-1.5">
          ...
          <span className="truncate">{username ?? <span className="italic opacity-50">not logged in</span>}</span>
        </div>
      </div>
